        ...
        <div className="footer-container">
          <div className="left-footer">
            <Link to="/" className="text-white text-decoration-none">
              <span className="logo font-2xl">my</span>
              <span className="logo font-2xl color-orange">Goal</span>
            </Link>
            <p className="mt-3 fs-5">Contact Me</p>
            ...
            <p className="mt-3">&copy; 2024 - {new Date().getFullYear()} by myGoal. All rights reserved.</p>
          </div>
